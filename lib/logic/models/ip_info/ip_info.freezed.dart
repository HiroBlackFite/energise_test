...
mixin _$IPInfo {
  ...
  IPInfoStatus get status => throw _privateConstructorUsedError;
...
abstract class _$$IPInfoImplCopyWith<$Res> implements $IPInfoCopyWith<$Res> {
  factory _$$IPInfoImplCopyWith(
          _$IPInfoImpl value, $Res Function(_$IPInfoImpl) then) =
...
class __$$IPInfoImplCopyWithImpl<$Res>
  ...
  __$$IPInfoImplCopyWithImpl(
      _$IPInfoImpl _value, $Res Function(_$IPInfoImpl) _then)
      : super(_value, _then);
...
class _$IPInfoImpl implements _IPInfo {
  ...
  @override
  String toString() {
    return 'IPInfo(query: $query, status: $status, message: $message, country: $country, countryCode: $countryCode, region: $region, regionName: $regionName, city: $city, zip: $zip, lat: $lat, lon: $lon, timezone: $timezone, isp: $isp, org: $org, as: $as)';
  }
...
abstract class _IPInfo implements IPInfo {
  const factory _IPInfo(
      ...
      required final IPInfoStatus status,
      final String? message,
      ...
      required final String as}) = _$IPInfoImpl;
